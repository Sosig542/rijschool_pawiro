...
import { MobileNewsModal } from "@/app/components/MobileNewsModal";
...
export default async function Portal({
  ...
  return (
    <>
      {/* Mobile News Modal */}
      <MobileNewsModal newsletters={news} />
      ...
      <div className="flex flex-col lg:flex-row gap-6">
                  ...
                  <div className="text-sm text-gray-600 text-center py-4">
                    ...
                    {(student as any).theoryStatus === "GESLAAGD" &&
                      (student as any).completedLessons < 8 && (
                        <div className="mt-2">
                          You can book lessons below once you've passed your
                          theory exam.
                        </div>
                      )}
                  </div>
              ...
              (student as any).lessonBookings.filter(
                ...
                <div className="card p-4">
                  ...
                  <div className="text-sm text-gray-600 mb-2">
                    You have completed {(student as any).completedLessons} out
                    of 8 required practical lessons.
                  </div>
                ...
                <div className="card p-4">
                  ...
                  <div className="text-sm text-gray-600 text-center py-4">
                    ...
                    {(student as any).theoryStatus !== "GESLAAGD" && (
                      <div className="mt-2">
                        You need to pass your theory exam first before you can
        ...
        {/* Right Sidebar - Newsletters (Desktop Only) */}
        <div className="hidden lg:block lg:w-80 lg:flex-shrink-0">
          <div className="sticky top-6">
            <div className="card p-4">
              <h3 className="font-semibold mb-3 text-sky-700">Latest News</h3>
              {news.length === 0 ? (
                <div className="text-sm text-gray-600 text-center py-4">
                  No news yet.
                </div>
